		...
		if ( isset( $post_type ) && 'it_exchange_prod' === $post_type ) {
			...
			if ( empty( $_GET['tab'] ) ) {
				...
				wp_localize_script( 'it-exchange-settings-general', 'settingsGenearlL10n', array(
						'delteConfirmationText'  => __( 'You have checked the option to "Reset ALL data". Are you should you want to delete all Exchange products, transactions, and settings?', 'it-l10n-ithemes-exchange' ),
					)
				);
