...
class IT_Exchange_Product_Feature_Product_Title {
	...
	*/
	function IT_Exchange_Product_Feature_Product_Title() {
		...
		add_filter( 'it_exchange_product_supports_feature_title', array( $this, 'product_supports_feature') , 9, 2 );
	}
	...
	*/
	function print_metabox( $post ) {
		?>
			<label for="title"><?php _e( 'Product Title', 'it-l10n-ithemes-exchange' ); ?> <span class="tip" title="<?php _e( 'Name your product like you do a headline &mdash; to catch attention and sell benefits.', 'it-l10n-ithemes-exchange' ); ?>">i</span></label>
