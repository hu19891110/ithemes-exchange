...
class IT_Exchange_Product_Feature_Product_Images {
	...
	*/
	function print_metabox( $post ) {
		...
		<label for="product-images-field">Images<span class="tip" title="<?php _e( 'Uploading large images is best (1600px or greater). Exchange will resize the images to use in the store.', 'it-l10n-ithemes-exchange' ) ?>">i</span></label>
