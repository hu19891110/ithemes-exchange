...
<div class="it-exchange-checkout-logged-in-purchase-requirement">
	<?php if ( ! is_user_logged_in() ) : ?>
		...
		<h3><?php _e( 'Register or Log in', 'it-l10n-ithemes-exchange' ); ?></h3>
	...
	<?php else : ?>
		<?php printf( __( 'Logged in as: %s', 'it-l10n-ithemes-exchange' ), it_exchange( 'customer', 'get-display-name', array( 'format' => 'field-value' ) ) ); ?> <?php wp_loginout( it_exchange_get_page_url( 'checkout' ) ); ?>
	<?php endif; ?>
</div>
